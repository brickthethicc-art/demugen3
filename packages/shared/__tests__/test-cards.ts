import { CardType, AbilityType } from '../src/types/index.js';
import type { UnitCard, SorceryCard, Card } from '../src/types/index.js';
...
// ── Unit Cards (42) - ACTUAL GAME CARDS ──────────────────────────────────────────────────
...
export const ALL_UNITS: UnitCard[] = [
  ...
  unit('u10', 'Wind Dancer', 3, 5, 3, 3, 1, 'a10', 'Gale Strike', 'Deal 2 damage to adjacent enemy', 2, AbilityType.DAMAGE),
  unit('u11', 'Moss Shaman', 3, 5, 1, 2, 2, 'a11', 'Rejuvenate', 'Heal 3 HP to target ally', 2, AbilityType.HEAL),
  unit('u12', 'Sand Viper', 3, 5, 3, 2, 1, 'a12', 'Venom Bite', 'Reduce target ATK by 1', 2, AbilityType.MODIFIER),
  ...
  unit('u14', 'Coral Guardian', 4, 9, 2, 1, 1, 'a14', 'Tidal Shield', 'Gain +1 ATK until end of turn', 3, AbilityType.BUFF),
  ...
  unit('u17', 'Forest Warden', 4, 7, 3, 2, 2, 'a17', 'Nature\'s Gift', 'Heal 3 HP to target ally', 3, AbilityType.HEAL),
  unit('u18', 'Magma Brute', 4, 8, 4, 1, 1, 'a18', 'Eruption', 'Deal 2 damage to adjacent enemy', 3, AbilityType.DAMAGE),

  // Cost 5: Heavy hitters
  unit('u19', 'Storm Dragon', 5, 8, 5, 2, 2, 'a19', 'Lightning Breath', 'Deal 3 damage to target in range', 3, AbilityType.DAMAGE),
  ...
  unit('u22', 'Plague Doctor', 5, 7, 3, 2, 2, 'a22', 'Pestilence', 'Reduce target ATK by 2', 3, AbilityType.MODIFIER),
  ...
  // Cost 6: Powerhouses
  unit('u25', 'Titan Golem', 6, 14, 4, 1, 1, 'a25', 'Earthquake', 'Deal 3 damage to adjacent enemy', 4, AbilityType.DAMAGE),
  unit('u26', 'Phoenix Sage', 6, 8, 4, 2, 3, 'a26', 'Rebirth Flame', 'Heal 3 HP to self', 4, AbilityType.HEAL),
  unit('u27', 'Void Stalker', 6, 9, 5, 3, 1, 'a27', 'Dimensional Rift', 'Deal 3 damage, ignore counter', 4, AbilityType.MODIFIER),
  unit('u28', 'Ancient Treant', 6, 12, 3, 1, 2, 'a28', 'Root Network', 'Heal 3 HP to target ally', 4, AbilityType.HEAL),
  unit('u29', 'Inferno Djinn', 6, 9, 5, 2, 2, 'a29', 'Firestorm', 'Deal 3 damage to target in range', 4, AbilityType.DAMAGE),
  unit('u30', 'Glacial Behemoth', 6, 13, 4, 1, 1, 'a30', 'Frozen Slam', 'Reduce target movement by 1', 4, AbilityType.MODIFIER),

  // Cost 7: Elite
  unit('u31', 'Archangel', 7, 10, 6, 2, 3, 'a31', 'Holy Nova', 'Heal 3 HP to target ally', 5, AbilityType.HEAL),
  unit('u32', 'Demon Lord', 7, 11, 7, 2, 1, 'a32', 'Hellfire', 'Deal 3 damage to target in range', 5, AbilityType.DAMAGE),
  unit('u33', 'Chrono Wizard', 7, 8, 4, 2, 3, 'a33', 'Time Warp', 'Gain +3 ATK until end of turn', 5, AbilityType.BUFF),
  unit('u34', 'Leviathan', 7, 14, 5, 1, 2, 'a34', 'Tidal Crush', 'Deal 3 damage to adjacent enemy', 5, AbilityType.DAMAGE),

  // Cost 8: Legendaries
  unit('u35', 'World Serpent', 8, 16, 6, 1, 1, 'a35', 'Cataclysm', 'Deal 3 damage to adjacent enemy', 6, AbilityType.DAMAGE),
  unit('u36', 'Celestial Dragon', 8, 14, 7, 2, 2, 'a36', 'Astral Breath', 'Deal 3 damage to target in range', 6, AbilityType.DAMAGE),
  unit('u37', 'Eternal Guardian', 8, 18, 4, 1, 1, 'a37', 'Immortal Shield', 'Gain +4 ATK until end of turn', 6, AbilityType.BUFF),
...
export const TEST_UNITS = ALL_UNITS;
