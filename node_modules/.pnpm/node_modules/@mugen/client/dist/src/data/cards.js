...
function unit(id, name, cost, hp, atk, movement, range, abilityId, abilityName, abilityDesc, abilityCost, abilityType) {
    return {
        id,
        name,
...
function sorcery(id, name, cost, effect) {
...
// ── Combined ─────────────────────────────────────────────────────────
export const ALL_CARDS = [...ALL_UNITS, ...ALL_SORCERIES];
