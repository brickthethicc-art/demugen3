...
import type { PlayerColor } from '@mugen/shared/src/types/index.js';

// Mock the game store logic
function mockGameStoreLogic(gameState: any, playerId: string) {
  // OLD BUGGY LOGIC (what was happening before)
  const oldBuggyLogic = gameState.players.flatMap((p: any) => p.units);
