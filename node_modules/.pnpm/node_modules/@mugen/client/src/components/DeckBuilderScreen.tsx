  ...
  return (
    <div className="min-h-screen flex flex-col bg-mugen-bg text-white">
      ...
      <div className="flex-1 flex min-h-0">
        {/* Left: Card browser */}
        <div className="w-1/2 border-r border-white/5 p-4 flex flex-col min-h-0">
          <h2 className="text-sm font-semibold text-gray-400 mb-3">Card Browser</h2>
          <CardBrowser />
        </div>

        {/* Right: Current deck */}
        <div className="w-1/2 p-4 flex flex-col min-h-0">
          <h2 className="text-sm font-semibold text-gray-400 mb-3">Your Deck</h2>
          <DeckPanel />
        </div>
      </div>
    </div>
