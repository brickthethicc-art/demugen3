import { createLobby, joinLobby, setReady, setSelectedDeck, leaveLobby, startGame, } from '../lobby/lobby-manager.js';
...
export function setupGateway(io, state) {
    io.on('connection', (socket) => {
        ...
        socket.on('set_selected_deck', (data) => {
        ...
        socket.on('confirm_starting_units', (data) => {
            ...
            const updatedPlayers = gameState.players.map(p => p.id === playerId
